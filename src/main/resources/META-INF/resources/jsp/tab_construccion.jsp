		...
		<div class="card ">
			...
			<div id="collapseCoberturaAdicional" class="collapse in" role="tabpanel" aria-labelledby="headingCoberturaAdicional" data-parent="#accordionEx">
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="md-form form-group">
							...
							<label for="ca_rcAsumida">RC Maquinas de Trabajo</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="md-form form-group">
							<select id="ca_instaSubte" name="ca_instaSubte" class="mdb-select form-control-sel">
								<option value="-1" selected><liferay-ui:message key="LiabilityQuotationPortlet.selectOpDefoult" /></option>
							</select>
							<label for="ca_instaSubte">Instalaciones Subterraneas</label>
						</div>
					</div>
					<div class="col-md-3">
						<div class="md-form form-group">
							<select id="ca_rcSoldadura" name="ca_rcSoldadura" class="mdb-select form-control-sel">
								<option value="-1" selected><liferay-ui:message key="LiabilityQuotationPortlet.selectOpDefoult" /></option>
							</select>
							<label for="ca_rcSoldadura">RC Trabajos de Soldadura</label>
						</div>
					</div>
					<div class="col-md-3">
						<div class="md-form form-group">
							<select id="ca_rcApuntalamiento" name="ca_rcApuntalamiento" class="mdb-select form-control-sel">
								<option value="-1" selected><liferay-ui:message key="LiabilityQuotationPortlet.selectOpDefoult" /></option>
							</select>
							<label for="ca_rcApuntalamiento">RC Apuntalamiento</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="md-form form-group">
							<select id="ca_demolicion" name="ca_demolicion" class="mdb-select form-control-sel">
								<option value="-1" selected><liferay-ui:message key="LiabilityQuotationPortlet.selectOpDefoult" /></option>
							</select>
							<label for="ca_demolicion">Demolición</label>
						</div>
					</div>
					<div class="col-md-3">
						<div class="md-form form-group">
					...
					<div class="col-md-3">
						<div class="md-form form-group">
							<select id="ca_rcObrasEspe" name="ca_rcObrasEspe" class="mdb-select form-control-sel">
								<option value="-1" selected><liferay-ui:message key="LiabilityQuotationPortlet.selectOpDefoult" /></option>
							</select>
							<label for="ca_rcObrasEspe">RC Obras Especiales</label>
						</div>
					</div>
					<div class="col-md-3">
						<div class="md-form form-group">
